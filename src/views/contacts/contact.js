...
import { CButton, CCard, CCardBody, CCardHeader, CCardTitle, CCol, CForm, CFormInput, CFormLabel, CFormSelect, CFormTextarea, CImage, CModal, CModalBody, CModalFooter, CModalHeader, CRow, CSpinner } from '@coreui/react'
    ...
    const handleSubmit = async(e)=>{
        e.preventDefault()
            ...
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_BASE_URL}group-members`, {
      ...
      <CRow>
            <CCol xs={10} style={{margin:"0 auto"}}>
                ...
                <CCardBody style={{padding:"35px"}}>
                    ...
                    <div className="mb-3">
                        <CFormLabel htmlFor="exampleFormControlInput1">Contact Name</CFormLabel>
                        <CFormInput
                            type="text"
